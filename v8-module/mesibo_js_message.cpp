...
mesibo_int_t v8_on_message_status(mesibo_module_t *mod, mesibo_message_params_t *p, mesibo_uint_t status) {
	...
	mesibo_int_t rv = mesibo_js->OnMessageStatus(&mp, status);	
...
Local<Object> MesiboJsMessage::CtoJ_MessageParams(Isolate* isolate,
	...
	MesiboJsUtil::CtoJ_Uint(isolate, context, message_obj, MESSAGE_TO_ONLINE, p->to_online);
...
mesibo_message_params_t* MesiboJsMessage::JtoC_MessageParams(Isolate* isolate, 
	...
	mp->to_online = MesiboJsUtil::JtoC_ParamUint(isolate, context, MESSAGE_TO_ONLINE, params);	
